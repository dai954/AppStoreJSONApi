...
//        This code was duprecated
//        let height = UIApplication.shared.statusBarFrame.height
//        print("statusbar height1:",height)
        
//        print("statusbar height2:",statusbarHeight)
...
//        add our subviews
        ...
        let stackView = UIStackView(arrangedSubviews: [
            imageView,
            VerticalStackView(arrangedSubviews: [UILabel(text: "Life Hack", font: .boldSystemFont(ofSize: 16)),
                                                 UILabel(text: "Utlizing you Time", font: .systemFont(ofSize: 16))
            ], spacing: 4),
            getButton
        ], customSpacing: 16)
